...
#define CONFIG_EXTRA_ENV_SETTINGS \
	"bootk=" \
		...
		"bootm 20008000\0" \
	"nfsboot=" \
		"set bootargs noinitrd console=ttySAC0 root=/dev/nfs rw nfsroot=192.168.169.201:/home/work/nfs/210-rootfs,v3,nolock,tcp ip=192.168.169.202 init=/linuxrc; " \
		"run bootk\0"
 ...
 * SPL Settings
 */
#define CONFIG_SPL_LDSCRIPT		"board/samsung/tq210/u-boot-spl.lds"
