...
#define CONFIG_MACH_MC210	1	/* working with mc210 */
...
/* mc210 has 2 banks of DRAM, but swap the bank */
#define CONFIG_NR_DRAM_BANKS	2
#define PHYS_SDRAM_1		0x20000000	/* DDR2 Bank #0 */
#define PHYS_SDRAM_1_SIZE	SZ_256M		/* 256 MB in Bank #0 */
#define PHYS_SDRAM_2		0x40000000	/* DDR2 Bank #1 */
#define PHYS_SDRAM_2_SIZE	SZ_256M		/* 256 MB in Bank #1 */
 ...
 * Default Environment
 */
#define CONFIG_BOOTARGS		"noinitrd console=ttySAC2 root=/dev/mmcblk0p2 rw " \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	"bootk=" \
		...
		"bootm 20008000\0" \
	"nfsboot=" \
		"set bootargs noinitrd console=ttySAC2 root=/dev/nfs rw nfsroot=192.168.2.200:/mnt/qiang/work/nfs/rootfs,v3,nolock,tcp ip=dhcp init=/linuxrc coherent_pool=2M; " \
		"run bootk\0"
